    ...
    public void updateData() {
        ValueEventListener postListner = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(prevGameVarModel.getCurr_die_val() != OnlineMode.super.gameVarModel.getCurr_die_val()){
                    if(OnlineMode.super.isDEBUG()) {
                        System.out.print("Dice value changed: ");
                        System.out.print("Before: " + prevGameVarModel.getCurr_die_val());
                        System.out.println(" After: " + OnlineMode.super.gameVarModel.getCurr_die_val());
                    }
                    OnlineMode.super.updateDice();
                }
                else if(!prevGameVarModel.getSrc().equals(OnlineMode.super.gameVarModel.getSrc())) {
                    if (OnlineMode.super.isDEBUG()) {
                        System.out.print("Src changed: ");
                        System.out.print("Before: " + prevGameVarModel.getSrc());
                        System.out.println("After: " + OnlineMode.super.gameVarModel.getSrc());
                    }
...
//                if(!prevGameVarModel.getDest().equals(OnlineMode.super.gameVarModel.getDest())){
//                    if (OnlineMode.super.isDEBUG()) {
//                        System.out.print("Dest changed: ");
//                        System.out.print("Before: " + prevGameVarModel.getDest());
//                        System.out.println("After: " + OnlineMode.super.gameVarModel.getDest());
//                    }
//                }
